...
(function () {
  ...
  var CSS = [
    ...
    '@media(max-width:600px){',
      ...
      '#zwlg-modal .zwlg-box{width:100%;max-width:100%;max-height:92dvh;border-radius:1.25rem 1.25rem 0 0;border-top:none;border-left:none;border-right:none;padding:2.4rem 1.4rem calc(1.8rem + env(safe-area-inset-bottom,0px));transform:translateY(100%);}',
